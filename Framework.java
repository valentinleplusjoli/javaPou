...
public class Framework extends Canvas {
   ...
   /**
    ...
    private void LoadContent()
    {
        try
        {
            URL moonLanderMenuImgUrl = this.getClass().getResource("/moon_lander/resources/images/background.png");
    ...
    public void Draw(Graphics2D g2d)
    {
        switch (gameState)
        {
            ...
            case MAIN_MENU:
                ...
                g2d.drawString("Utilise Q D et Espace pour controler le Pou.", frameWidth / 2 - 117, frameHeight / 2);
                g2d.drawString("Pressez une touche pour commencer", frameWidth / 2 - 100, frameHeight / 2 + 30);
